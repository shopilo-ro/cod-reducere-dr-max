#!/usr/bin/env node
/**
 * Fetch coduri reducere Dr. Max de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/drmax.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/drmax.ro";
const STORE_NAME  = "Dr. Max";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-dr-max)" }
  });
