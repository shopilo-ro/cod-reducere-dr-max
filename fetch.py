#!/usr/bin/env python3
"""
Fetch coduri de reducere Dr. Max de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/drmax.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/drmax.ro"
STORE_NAME = "Dr. Max"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Dr. Max de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-dr-max)"
    }
    try:
